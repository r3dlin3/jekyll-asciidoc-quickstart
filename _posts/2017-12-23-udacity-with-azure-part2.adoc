...
Nous prenons ici la suite du https://eu.udacity.com/course/scalable-microservices-with-kubernetes--ud615[cours gratuit] d'Udacity sur Docker, les microservices et Kubernetes.
